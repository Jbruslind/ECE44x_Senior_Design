...
class Ui_MicrobialAnalysis(object):
    def setupUi(self, MicrobialAnalysis):
        ...
        self.numberOfSamples.setGeometry(QtCore.QRect(130, 80, 81, 31))
        self.numberOfSamples.setMaximum(999)
        self.numberOfSamples.setObjectName("numberOfSamples")
        self.spinBoxFrame = QtWidgets.QFrame(self.controls)
        self.spinBoxFrame.setGeometry(QtCore.QRect(10, 60, 201, 80))
        self.spinBoxFrame.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.spinBoxFrame.setFrameShadow(QtWidgets.QFrame.Raised)
        self.spinBoxFrame.setObjectName("spinBoxFrame")
        self.spinBoxLabel = QtWidgets.QLabel(self.spinBoxFrame)
        self.spinBoxLabel.setGeometry(QtCore.QRect(0, 10, 121, 61))
        ...
        self.buttonsWidget.setGeometry(QtCore.QRect(10, 160, 221, 321))
        ...
        self.buttonsWidget.raise_()
        self.spinBoxFrame.raise_()
        self.numberOfSamples.raise_()
